...
# Hyper-parameters，定义各层规模及其他超参数 input_size = 784
hidden_size = 500
num_classes = 10
num_epochs = 5
batch_size = 100
...
# 定义网络结构，Fully connected neural network with one hidden layer class NeuralNet(nn.Module):
def __init__(self, input_size, hidden_size, num_classes):
    super(NeuralNet, self).__init__()
    self.fc1 = nn.Linear(input_size, hidden_size) self.relu = nn.ReLU()
